...
# Bots Channel: @Animemusicarchive6
...
async def HelpWatermark(bot, cmd):
	...
	await cmd.reply_text(
		...
		parse_mode="Markdown",
		reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Developer", url="https://t.me/Achubiju6c"), InlineKeyboardButton("Support Group", url="https://t.me/Yeageristbots")], [InlineKeyboardButton("Bots Channel", url="https://t.me/Animemusicarchive6")], [InlineKeyboardButton("Source Code", url="https://github.com/AbirHasan2005/Watermark-Bot")]]),
		disable_web_page_preview=True
	)
...
async def VidWatermarkAdder(bot, cmd):
	...
	try:
		...
		sent_vid = await bot.send_video(
			...
			reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Developer", url="https://t.me/Achubiju6c")], [InlineKeyboardButton("Bots Channel", url="https://t.me/Animemusicarchive6")], [InlineKeyboardButton("Support Group", url="https://t.me/Yeageristbots")]]),
			progress=progress_for_pyrogram,
			progress_args=(
				"Uploading, Wait Sir ...",
				editable,
...
async def button(bot, cmd: CallbackQuery):
	...
	if "refreshmeh" in cb_data:
		...
		await cmd.message.edit(
			text=Config.USAGE_WATERMARK_ADDER,
			parse_mode="Markdown",
			reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Developer", url="https://t.me/Achubiju6c5"), InlineKeyboardButton("Support Group", url="https://t.me/Yeageristbotso")], [InlineKeyboardButton("Bots Channel", url="https://t.me/Animemusicarchive6s")]]),
			disable_web_page_preview=True
		)
